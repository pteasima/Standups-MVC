...
struct SpeechRecognizer {
  //TODO: do these need to be @Sendable? Poinfreeco are using that for DependencyKeys, but idk if it applies to EnvironmentKeys
  var authorizationStatus: () -> SFSpeechRecognizerAuthorizationStatus
  var requestAuthorization: () async -> SFSpeechRecognizerAuthorizationStatus
  var startTask: (SFSpeechAudioBufferRecognitionRequest) async -> AsyncThrowingStream<
      SpeechRecognitionResult, Error
    >
}

extension SpeechRecognizer: EnvironmentKey {
